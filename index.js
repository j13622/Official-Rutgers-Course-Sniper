...
client.sectionUser = new Collection();
client.courses = new Collection();
client.tagSection = new Collection();
client.sectionName = new Collection();
client.sectionTime = new Collection();
client.term;

client.isIterable = object =>
